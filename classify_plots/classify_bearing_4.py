...
def main():
    ...
    if not os.path.exists("classifier_model_bearing_4.p"):
        ...
        torch.save(network.state_dict(), "classifier_model_bearing_4.p")
    else:
    ...
    np.save("classify_plot_data_bearing_4.npy", plot_data)
