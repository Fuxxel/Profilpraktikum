...
def main():
    ...
    train_data_bearing_4 = expand_and_annotate_list_bearing_4(train_list_bearing_4, gt_list_bearing_4)
    ...
    print("Loading training data bearing 4...")
    train_data_loader_bearing_4 = DataLoader(train_data_bearing_4, batch_size=1024, sensor=0, sample_length=1024)
    ...
    train_balance = train_data_loader_bearing_4.get_category_balance()
    ...
    network.load_state_dict(torch.load("classifier_model_bearing_5.p"))
    ...
    for current_epoch in range(epochs):
        ...
        print("Training:")
        network.train()
        for i, (input, target) in enumerate(train_data_loader_bearing_4):
            optimizer.zero_grad()
            ...
            loss.backward()
            optimizer.step()
        losses_bearing_4.append(loss_aggregation / (i + 1))
        print()
    ...
    pickle.dump({"loss_bearing_4": losses_bearing_4, "acc_bearing_5": acc_bearing_5, "acc_bearing_4": acc_bearing_4}, open("classify_continue_training_on_4_stats.p", "wb"))
    ...
    np.save("classify_continue_plot_data_on_bearing_4_test_5.npy", plot_data_bearing_5)
    ...
    np.save("classify_continue_plot_data_on_bearing_4_test_4.npy", plot_data_bearing_4)
