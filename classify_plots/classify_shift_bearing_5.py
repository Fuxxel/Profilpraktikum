...
gt_0 = "2019_03_16__14_52_12.mat"
gt_1 = "2019_03_16__14_54_11.mat"
...
def expand_with_offset(txt_list, offset):
    ...
    for i, entry in enumerate(txt_list):
        result.append([os.path.abspath(os.path.join("Data/Lager5/complete_set/", entry)), 0 if i < zero_index else 1])
    return result
    ...
    for current_run in range(num_runs):
        ...
        with torch. no_grad():
            for i, (data_file, category) in enumerate(test_data):
                if gt_0 in data_file or gt_1 in data_file:
...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--save_path", type=str, default="classify_shift_results_bearing_5")
