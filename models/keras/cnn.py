...
def build_cnn_model(parameters):
	...
	## Upwards pass
	conv_7 = Conv1D(num_filters, filter_size, padding="same", activation="relu", name="latent_space")(down_6)  # --> latent space
	...
	decoder_output = Conv1D(1, filter_size, padding="same", activation="sigmoid", name="decoder_output")(up_6)
...
def build_cnn_model_test(parameters, weights_file):
	...
	## Upwards pass
	conv_7 = Conv1D(num_filters, filter_size, padding="same", activation="relu", name="latent_space")(down_6)  
	up_1 = UpSampling1D(2)(conv_7) # 32
